(function(){
  ...
  function userService(){
    ...
    //Inicio de función de permitir cambios editados, si, solo si la identificación es la misma
  ...
  //Fin de función de permitir cambios editados, si, solo si la identificación es la misma
